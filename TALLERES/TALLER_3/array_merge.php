...
$misComidas = ["Arroz con pollo", "Sancocho de Pollo", "Hojaldre"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "Hamburguesa", "Hot Dog"]; // Reemplaza con las comidas favoritas de tu amigo
