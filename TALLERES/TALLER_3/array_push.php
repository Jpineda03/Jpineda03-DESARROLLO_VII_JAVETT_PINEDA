...
$misAmigos = ["Ailenis", "Deylian", "Max"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Gadia", "Alexis"); // Reemplaza las comillas vacías con los nombres de tus amigos
