...
$miArray = ["Quesos", "Jamones", "Panes"]; // Reemplaza esto con tu propio array
$miString = "Cervezas , Vinos"; // Reemplaza esto con tu propio string
$miNumero = 2; // Reemplaza esto con tu propio número
