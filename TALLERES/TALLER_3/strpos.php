...
$texto = "Hola, Javett!";
$posicion = strpos($texto, "Javett");
echo "La palabra 'Javett' comienza en la posición: $posicion</br>";

// Búsqueda que no encuentra resultados
$busqueda = strpos($texto, "Programacion");
if ($busqueda === false) {
    echo "La palabra 'Programacion' no se encontró en el texto.</br>";
}
