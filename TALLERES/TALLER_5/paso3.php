...
function estudiantesNecesitanTutoria($estudiantes) {
    $estudiantesTutoria = array_filter($estudiantes, function($estudiante) {
...
// 9. Función para listar a los estudiantes de honor (promedio de 90 o más)
function estudiantesDeHonor($estudiantes) {
    $estudiantesHonor = array_filter($estudiantes, function($estudiante) {
