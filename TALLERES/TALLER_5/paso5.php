...
$ventas = [
    ...
    ["producto_id" => 1, "cliente_id" => 102, "cantidad" => 1, "fecha" => "2024-09-04"],
    ["producto_id" => 4, "cliente_id" => 103, "cantidad" => 1, "fecha" => "2024-09-05"],
    ["producto_id" => 5, "cliente_id" => 101, "cantidad" => 2, "fecha" => "2024-09-06"],
    ["producto_id" => 2, "cliente_id" => 101, "cantidad" => 1, "fecha" => "2024-09-07"]
];
